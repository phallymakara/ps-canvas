...
describe("buildPrompt — items are named in language", () => {
  ...
  it("an English list item uses \"...\" quotes", () => {
    const item: Item = { id: "l1", kind: "listItem", label: "Item", icon: "person", icon2: "chevron_right", variant: "filled" };
